...
public class SearchEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ArrayList empList = UserService.SearchEmployee(request.getParameter("FirstName"), request.getParameter("LastName"), request.getParameter("Gender"), request.getParameter("Department"), request.getParameter("Role"));
